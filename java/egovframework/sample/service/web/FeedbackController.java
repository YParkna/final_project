...
public class FeedbackController {
	...
	public String insertFeedback(FeedbackVO vo) throws Exception  {
		...
		if (!uploadphoto.isEmpty()) {
			...
			uploadphoto.transferTo(new File(""
					+ "C:\\eGovFrame-3.10.0\\workspace.edu\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\project\\photo\\" + photo));
...
//			uploadphoto.transferTo(new File("C:/eGovFrameDev-3.10.0-64bit/workspace/.metadata/.plugins/org.eclipse.wst.server.core/project2/src/main/webapp/photo/" + photo));
	...
	public String updateFeedback(@ModelAttribute("feedback") FeedbackVO vo) throws Exception{
		...
		if (!uploadphoto.isEmpty()) {
			...
			photo = uuid + "." + ext;
			// 파일을 프로젝트 내의 특정 디렉토리에 저장
			uploadphoto.transferTo(new File("C:\\eGovFrame-3.10.0\\workspace.edu\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\project\\photo\\" + photo));
			
			// 기존 사진 파일 경로를 가져옴
	        String oldPhotoPath = "C:\\eGovFrame-3.10.0\\workspace.edu\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\project\\photo\\" + vo.getPhoto();
	...
	public String deleteFeedback(@ModelAttribute("feedback") FeedbackVO vo) throws Exception {
		...
		// 기존 사진 파일 경로를 가져옴
        String oldPhotoPath = "C:/eGovFrameDev-3.10.0-64bit/workspace/project2/src/main/webapp/photo/" + vo.getPhoto();
